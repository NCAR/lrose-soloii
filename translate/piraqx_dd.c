...
void piraqx_dd_conv();
int piraqx_isa_new_vol();
int piraqx_isa_new_sweep();
int piraqx_select_ray();
void piraqx_print_stat_line();
void piraqx_reset();
static void piraqx_ini();
void piraqx_name_replace();
void piraqx_name_aliases();
static int piraqx_next_ray();
static void piraqx_backwards_reset();
static void piraqx_map_hdr();
...
int piraqx_inventory();
void piraqx_dump_this_ray();
void piraqx_print_headers();
void piraqx_print_hdr();
void piraqx_print_rhdr();
static void products();
static size_t newsimplepp();
int piraqx_next_block();
...
static struct input_read_info *return_pir_irq();
...
void
piraqx_dd_conv(interactive_mode)
...
void piraqx_name_replace(name, top)
  char *name;
...
void piraqx_name_aliases(aliases, top)
  char *aliases;
  struct rename_str **top;
{
...
{
    int ii, jj, kk, nn;
    char *aa, str[256], *str_terminate(), tmp[256];
