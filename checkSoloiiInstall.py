...
#===========================================================================
#
# Check that all soloii apps are installed
...
def main():
    ...
    global requiredApps
    requiredApps = [ 'soloii', 'ddex', 'nx_reblock', 'xltrs' ]
    ...
    if (len(missingApps) > 0):
        ...
        print("=====>> INCOMPLETE soloii APPS INSTALLATION <<====", file=sys.stderr)
        ...
        print("=========>> ALL soloii APPS INSTALLED <<========", file=sys.stderr)
        print("===============================================", file=sys.stderr)

    if (len(oldApps) > 0):
        print("==================>> WARNING <<====================", file=sys.stderr)
        print("=====>> SOME soloii APPS ARE OLD <<====", file=sys.stderr)
