...
struct field_lidar_i {
    char field_lidar_info[4];   /* Identifier for a field written */
                                ...
                                /* characters "FLIB"). */
    long field_lidar_info_len;  /* Length of the field written lidar */
                                /* information block . */
    long data_sys_id;           /* Data system identification number. */
    ...
    long receiver_type[10];     /* 0=direct detection,no */
    ...
    float calibration[10];      /* 0 = linear receiver,  non zero log */
                                /* reciever */
    long range_delay;           /* Delay between indication of */
    ...
    long max_digitizer_count;   /* Maximum value (count) out of the */
                                /* digitizer  */
    ...
    long total_num_samples;     /* Total number of A/D samples to */
                                /* take. */
    long samples_per_cell;      /* Number of samples average in range
				   per data cell. */
    long cells_per_ray;         /* Number of data cells averaged
				   per data ray. */
